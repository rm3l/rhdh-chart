...
**Important:** After any change to the dependency structure or version of the vendored chart, you must rebuild the lock file:
...
Now, to contribute changes back to the upstream repo, you can push them directly to your personal fork of the upstream Backstage charts and open up a PR:
